...
var tracksTemplateSource1 = document.getElementById('tracks-template1').innerHTML;
var tracksTemplate1 = Handlebars.compile(tracksTemplateSource1);
var $tracks1 = $('#tracks-container1');
var getTopTracks1 = $.get('https://api.napster.com/v2.1/tracks/top?apikey=ZGRhMzc3MzQtMjNlZS00MGRiLThmOGMtYzE2ZjJhMzYyNDNj');
getTopTracks1.then(function (response) {
