...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/napster.js":[function(require,module,exports) {
//search
var $search = $('#search');
var myArray = new Array();
var save = document.getElementById("search");
var searchInput = document.getElementById("searchInput");
searchInput.addEventListener('keypress', Search);

function Search(e) {
  if (e.key != 'Enter') {
    var dump = 1; //(dummy command)
  } else {
    $("#search").html(""); //clear before display
    //get user input

    var searchInputValue = document.getElementById("searchInput").value; //console.log(searchInputValue); ( for debug only )

    var searchresult = $.get('http://api.napster.com/v2.2/search/verbose?apikey=ZGRhMzc3MzQtMjNlZS00MGRiLThmOGMtYzE2ZjJhMzYyNDNj&query=' + searchInputValue + '&type=track');
...
var displaytemplateSource = document.getElementById('display-temp').innerHTML;
var displaytemp = Handlebars.compile(displaytemplateSource);
var $display = $('#display-container');
var DisplayInput2 = document.getElementById("displayInput2");
...
function DisplayNow(e) {
  if (e.key != 'Enter') {
    ...
    $("#display").html("");
    var displayvalue = document.getElementById("displayInput2").value; //console.log(displayvalue);

    var display = $.get('http://api.napster.com/v2.2/tracks/' + displayvalue + '?apikey=YTkxZTRhNzAtODdlNy00ZjMzLTg0MWItOTc0NmZmNjU4Yzk4&range=week');
    display.then(function (response) {
...
var $mainTitle = $('.header');
var $backButton = $('.back-button');
var getTopPlaylists = $.get('https://api.napster.com/v2.0/playlists?apikey=ZTk2YjY4MjMtMDAzYy00MTg4LWE2MjYtZDIzNjJmMmM0YTdm');
...
getTopPlaylists.then(function (response) {
...
function addPlaylistListener() {
  $('.cover').on('click', function (e) {
    ...
    getPlaylistTracks($playlist.data('playlistId')).then(changeToTracks($playlist.data('playlistName')));
  });
}

var testtemplateSource = document.getElementById('test-template').innerHTML;
var testtemplate = Handlebars.compile(testtemplateSource);
var $test = $('#testcontainer');
var get = $.get('http://api.napster.com/v2.2/tracks/top?apikey=YTkxZTRhNzAtODdlNy00ZjMzLTg0MWItOTc0NmZmNjU4Yzk4&range=week');
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/napster.js"], null)
//# sourceMappingURL=/napster.a93ce1ef.js.map